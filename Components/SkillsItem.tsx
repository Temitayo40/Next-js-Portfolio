...
const SkillsItem = ({ title, year }: Props) => {
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      <span className="px-[2rem] text-[#55e6a5] py-[0.9rem] font-bold text-[18px] border border-[#55e6a5]">
        {year}
      </span>
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        ...
        optio maiores doloremque asperiores ut impedit est veritatis. Iste
        facere quod, nihil incidunt tempora quasi omnis perspiciatis quaerat
