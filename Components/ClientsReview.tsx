...
const ClientsReview = ({ name, role, image }: Props) => {
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <p className="text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto">
        ...
        reprehenderit suscipit accusamus recusandae. Culpa, obcaecati delectus
        doloribus est ad porro consequuntur unde magnam voluptatum enim
        inventore, minima officia laudantium?
      </p>
    </div>
  );
};
